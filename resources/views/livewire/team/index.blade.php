                ...
                <thead>
                    <tr>
                        ...
                        <th>
                            ...
                            @include('components.table.sort', ['field' => 'coach.name'])
                        </th>
                        <th>
                        ...
                        <th>
                            ...
                            @include('components.table.sort', ['field' => 'level'])
                        </th>
                        <th>
                            {{ trans('cruds.team.fields.oganization_name') }}
                            @include('components.table.sort', ['field' => 'oganization_name'])
                        </th>
                        <th>
                            {{ trans('cruds.team.fields.oganization_url') }}
                            @include('components.table.sort', ['field' => 'oganization_url'])
                        </th>
                        <th>
                            {{ trans('cruds.team.fields.division') }}
                            @include('components.table.sort', ['field' => 'division'])
                        </th>
                        <th>
                            {{ trans('cruds.team.fields.season') }}
                            @include('components.table.sort', ['field' => 'season'])
                        </th>
                        <th>
                        </th>
                    </tr>
